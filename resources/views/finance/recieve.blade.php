...
<section class="payment-form dark">
    ...
    <form method="post" action="{{url('recievingpayment')}}" >
      @csrf
            @method('post') 
            <div class="card-details">
            <h3 class="title"> Payment Receiving Invoice </h3>
                <div class="row">  
                    ...
                    <div class="input-group col-sm-12">	
                        ...
                        <label for="card-holder"> PAID AMOUNT</label>
                            <input id="card-holder" type="text" name="received" class="form-control" placeholder="" aria-label="Card Holder" aria-describedby="basic-addon1">
