...
<section class="payment-form dark">
    <div class="container">
      ...
      <form method="post" method="{{route('addnewsupplier')}}">

      @csrf
        @method('post')
            <div class="card-details">
            <h3 class="title">Create New Supplier </h3>
                <div class="row">  
                      
                    <div class="input-group col-sm-12">
                            <div class="form-group col-sm-7">
                            <label for="card-holder">Supplier Name</label>
                            <input id="card-holder" type="text" name="supplier_name" class="form-control" placeholder="" aria-label="Card Holder" aria-describedby="basic-addon1">
                        </div>
                    ...
                    <div class="input-group col-sm-12">	
                        ...
                        <div class="form-group col-sm-5">
                            ...
                            <input id="card-holder" type="text" name="contact_person" class="form-control" placeholder="AUTO FROM DATABASE" aria-label="Card Holder" aria-describedby="basic-addon1">
                        </div>
                    </div>              
